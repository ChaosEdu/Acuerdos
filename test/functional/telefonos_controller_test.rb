...
class TelefonosControllerTest < ActionController::TestCase
  ...
  test "should create telefono" do
    assert_difference('Telefono.count') do
      post :create, telefono: { empleado_id: @telefono.empleado_id, num_telefono: @telefono.num_telefono, tipo_telefono_id: @telefono.tipo_telefono_id }
    end
  ...
  test "should update telefono" do
    put :update, id: @telefono, telefono: { empleado_id: @telefono.empleado_id, num_telefono: @telefono.num_telefono, tipo_telefono_id: @telefono.tipo_telefono_id }
    assert_redirected_to telefono_path(assigns(:telefono))
  end
